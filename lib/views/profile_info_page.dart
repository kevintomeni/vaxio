...
class ProfileInfoPage extends StatelessWidget {
  final dynamic user;
  final dynamic role;
  const ProfileInfoPage({Key? key, this.user, this.role}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    // Utilise user et role pour pré-remplir ou envoyer les infos
    return BlocProvider(
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: state.gender.isNotEmpty && 
                                     ...
                                     !state.isLoading
                              ? () async {
                                  final user = await StorageService.instance.then((s) => s.getUser());
                                  ...
                                  try {
                                    ...
                                    // Affiche l’erreur à l’utilisateur (si tu es dans un StatelessWidget, affiche via un Snackbar ou autre)
